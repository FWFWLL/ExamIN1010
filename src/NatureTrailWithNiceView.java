public final class NatureTrailWithNiceView extends NatureTrail implements NiceView {
    protected int viewValue; // How nice the view is from 1 to 6 inclusive

    NatureTrailWithNiceView(int length, Crossing crossing1, Crossing crossing2, int viewValue) throws BadViewException {
